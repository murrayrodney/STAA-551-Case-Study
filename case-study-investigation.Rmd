...
## Brute Force Methods
```{r define functions for brute force methods}
...
numerical_formulas <- get_all_formula_combs(numerical_cols, interactions=2)

```

```{r}
numerical_perf <- fit_all_models(numerical_formulas)
```
